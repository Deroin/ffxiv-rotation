...
class SaveAsPreset extends React.Component<propsType, stateType> {
...
function PresetLine(props: { line: Line }) {
    ...
    return <div style={{marginBottom: "8px"}}>
        <Clickable content={clickableContent} style={addLineStyle}
                   onClickFn={controller.displayingUpToDateGameState ? (() => {

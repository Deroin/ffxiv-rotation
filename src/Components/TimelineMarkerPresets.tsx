...
function PresetButtons() {
    ...
    let content = <div style={{lineHeight: "2em"}}>
        <LoadCombinedTracksBtn displayName={"P1S Shackles of Time first"}
                               url={"https://miyehn.me/ffxiv-blm-rotation/presets/markers/p1s_shackles_of_time_first.txt"}/>
        <LoadCombinedTracksBtn displayName={"P1S Aetherial Shackles first"}
                               url={"https://miyehn.me/ffxiv-blm-rotation/presets/markers/p1s_aetherial_shackles_first.txt"}/>
        <LoadCombinedTracksBtn displayName={"P2S"}
                               url={"https://miyehn.me/ffxiv-blm-rotation/presets/markers/p2s.txt"}/>
        <br/>
        <LoadCombinedTracksBtn displayName={"DSR P7 by Santa"}
                               url={"https://miyehn.me/ffxiv-blm-rotation/presets/markers/dsr_p7.txt"}/>
        <LoadCombinedTracksBtn displayName={"TOP by Santa"}
                               url={"https://miyehn.me/ffxiv-blm-rotation/presets/markers/TOP_2023_04_02.track"}/>
        <br/>
        <span>{localize({en: "From 不打冰3攻略组, in Chinese: ", zh: "来自不打冰3攻略组："})}</span>
        <LoadCombinedTracksBtn displayName={"P5S"}
                               url={"https://miyehn.me/ffxiv-blm-rotation/presets/markers/p5s_zh.txt"}/>
        <LoadCombinedTracksBtn displayName={"P6S"}
                               url={"https://miyehn.me/ffxiv-blm-rotation/presets/markers/p6s_zh.txt"}/>
        <LoadCombinedTracksBtn displayName={"P7S"}
                               url={"https://miyehn.me/ffxiv-blm-rotation/presets/markers/p7s_zh.txt"}/>
        <LoadCombinedTracksBtn displayName={"P8S门神蛇轴"}
                               url={"https://miyehn.me/ffxiv-blm-rotation/presets/markers/p8s_p1_snake_zh.txt"}/>
        <LoadCombinedTracksBtn displayName={"P8S门神车轴"}
                               url={"https://miyehn.me/ffxiv-blm-rotation/presets/markers/p8s_p1_beast_zh.txt"}/>
        <LoadCombinedTracksBtn displayName={"P8S本体"}
                               url={"https://miyehn.me/ffxiv-blm-rotation/presets/markers/p8s_p2_zh.txt"}/>
        <br/>
        <LoadCombinedTracksBtn displayName={"P9S by Yara"}
                               url={"https://miyehn.me/ffxiv-blm-rotation/presets/markers/p9s.txt"}/>
        <LoadCombinedTracksBtn displayName={"P12S P1 by Yara"}
                               url={"https://miyehn.me/ffxiv-blm-rotation/presets/markers/p12s_p1.txt"}/>
        <LoadCombinedTracksBtn displayName={"P12S P2 by Yara"}
                               url={"https://miyehn.me/ffxiv-blm-rotation/presets/markers/p12s_p2.txt"}/>
    </div>
...
export class TimelineMarkerPresets extends React.Component {
    ...
    render() {
        ...
        let infoOnlySection = <div>
            <Input defaultValue={this.state.nextMarkerDescription}
                   description={localize({en: "Description: ", zh: "描述："})} width={40}
                   onChange={this.setDescription}/>
            <Input defaultValue={this.state.nextMarkerTrack} description={localize({en: "Track: ", zh: "轨道序号："})}
                   width={4}
            ...
            <div style={{display: "inline-block", marginTop: "4px", marginLeft: "10px"}}>
                <input type="checkbox" style={{position: "relative", top: 3}} checked={this.state.nextMarkerShowText}
        ...
        let content = <div>
            ...
            <Expandable
                title={"Load tracks"}
                titleNode={<span>
                    {localize({en: "Load tracks", zh: "导入"})} <Help topic={"load tracks"} content={localize({
                ...
                content={
                    <div>
                        <div className={"paragraph"}><b>{localize({en: "Multiple tracks combined", zh: "多轨文件"})}</b>
                        </div>
                        <LoadJsonFromFileOrUrl
                        ...
                        <div className={"paragraph"}>
                            <Input defaultValue={this.state.loadTrackDest}
                                   description={localize({en: "Track: ", zh: "轨道序号："})} width={8} style={inlineDiv}
            ...
            <Expandable title={"Add marker"} titleNode={localize({en: "Add marker", zh: "添加标记"})}
                ...
                <form style={{
                    ...
                    <select value={this.state.nextMarkerType}
                        ...
                        <option value={MarkerType.Untargetable}>{localize({
                            en: "Untargetable",
                            zh: "不可选中"
                        })}</option>
                    </select>
                    <span> </span>
                    <Input defaultValue={this.state.nextMarkerTime} description={localize({en: "Time: ", zh: "时间："})}
                           width={8} style={inlineDiv}
                           onChange={this.setTime}/>
                    <Input defaultValue={this.state.nextMarkerDuration}
                           description={localize({en: "Duration: ", zh: "持续时长："})} width={8}
